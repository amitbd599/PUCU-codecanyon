...
const BlogPageEditComponent = () => {
  return (
    <>
      <div className="m-[20px] rounded-xl bg-[#36404A] p-[30px]">
        <div className="flex items-center gap-2">
          <p className="text-xl font-medium text-white">Blog Info Edit</p>
          <InfoPopover img={"assets/images/popover/img-13.png"} />
        </div>
...
export default BlogPageEditComponent;
