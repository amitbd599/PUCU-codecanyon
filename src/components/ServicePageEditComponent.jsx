...
const ServicePageEditComponent = () => {
  return (
    <>
      <div className="m-[20px] rounded-xl bg-[#36404A] p-[30px]">
        <div className="flex items-center gap-2">
          <p className="text-xl font-medium text-white">Service Info Edit</p>
          <InfoPopover img={"assets/images/popover/img-14.png"} />
        </div>
...
export default ServicePageEditComponent;
